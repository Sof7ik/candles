<?php
    ...
    if(isset($_COOKIE['userInfo']))
    {
                ...
                {   
                    ...
                    if($newColor)
                    {
                        ...
                        // иначе останавливаем скрипт и выводим ошибку
                            ...
                            die("Ошибкка: " . mysqli_error($link) . 'строка 46');
                        }
                    ...
                    {
                        die("Ошибкка: " . mysqli_error($link) . 'строка 53');
                    }
                    break;
                }
            }
        ...
        if ($checkCandle)
        {
            ...
            else
            {
                ...
                {
                    die("Ошибка: " . mysqli_error($link) . 'строка 135');
                }
    ...
    {
        echo "<p style='color:red; font-size:40px;'>Вы не авторизованы!</p>";
